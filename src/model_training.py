...
class ModelTraining:
    def __init__(self,data_path):
        ...
        self.experiment = comet_ml.Experiment(
            api_key="1WFn01Sp3LxGOMW2WoFYwdTHe",
            project_name="kubernetes-project",
            workspace="lavkush-bansal"
        )
    ...
    def train_model(self):
        try:
            ...
            keras_callback = self.experiment.get_callback("keras")

            my_callbacks = [model_checkpoint,lr_callback,early_stopping, keras_callback]
